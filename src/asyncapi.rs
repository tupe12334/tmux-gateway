...
pub fn asyncapi_spec() -> Value {
    json!({
        ...
        "channels": {
            "wsPaneOutput": ws_channel(),
            "grpcStreamPaneOutput": grpc_channel(),
            "graphqlPaneOutput": graphql_channel()
        },
        "operations": {
            "receiveWsPaneOutput": ws_operation(),
            "receiveGrpcStreamPaneOutput": grpc_operation(),
            "receiveGraphqlPaneOutput": graphql_operation()
        },
        "components": {
